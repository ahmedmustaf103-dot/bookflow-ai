...
describe("onboarding copy", () => {
  ...
  it("keeps tour copy keyed and in plain language", () => {
    ...
    const allText = [
      ...
      onboardingCopy.tryDemo.kicker,
      onboardingCopy.tryDemo.title,
      onboardingCopy.tryDemo.body,
      onboardingCopy.tryDemo.continue,
      onboardingCopy.tryDemo.book,
      onboardingCopy.tryDemo.unavailable,
      onboardingCopy.tryDemo.missingShop,
      onboardingCopy.tryDemo.signedInTitle,
      onboardingCopy.tryDemo.signedInBody,
      onboardingCopy.tryDemo.dashboard,
      ...
      onboardingCopy.tryDemo.unavailableBilling,
      onboardingCopy.tryDemo.unavailableGoogle,
      onboardingCopy.tryDemo.unavailableTeam,
      onboardingCopy.tryDemo.unavailableAi,
      onboardingCopy.tryDemo.unavailableEdit,
